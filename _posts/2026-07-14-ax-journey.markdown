...
excerpt: 배포 시스템 개발기를 가장한 '완료 기념' 전사 AX(AI Transformation)에 대한 생각을 정리해 봤습니다.
...
결과는 사람이 작성한 코드와 AI가 작성한 코드의 평균 구현 일치도가 70%였습니다(태스크 설명이 제대로 작성된 구현 가능 PR 110건 기준). 100% 일치한 게 30개(태스크 설명이 상세한 PR의 23%), 90% 이상 거의 일치한 게 38개였습니다.
